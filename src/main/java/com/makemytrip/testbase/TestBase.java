...
public class TestBase {
	...
	public static String loginCloseBtn;
	//Flights
    ...
    public void setUp(String browser, String url) {
        ...
        try {
			fin = new FileInputStream("D:\\Automation_Projects\\MakeMyTrip\\Config\\locators.properties");
        ...
        loginCloseBtn = prop.getProperty("LoginCloseBtn");
        //Flights
